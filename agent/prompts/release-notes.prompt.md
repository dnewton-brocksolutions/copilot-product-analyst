...
Before generating release notes, read `documentation/business-analyst-workflow/project-config.json` to understand:

- **Work Tracking:** Tool, process, and work item types used by this project
- **Applications:** Frontend apps and backend services to reference in release notes
- **Standards:** Any project-specific formatting or release note conventions

Use actual application names and service names from the project config rather than generic placeholders.
